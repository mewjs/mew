...
// htmlint default configuration File
export default {
    ...
    'no-space-before-tag-end': false,       // false: There should be no whitespace before tag end
    ...
    'self-close': 'no-close',               // "no-close": Void tags should not close themselves  with "/"
    ...
    'linters': {},                          // extra linters ('script', 'style')
