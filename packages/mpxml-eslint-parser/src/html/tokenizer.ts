...
export class Tokenizer {
    ...
    readonly lineTerminators: number[];
     ...
     * @returns The next state.
     */
    protected NUMERIC_CHARACTER_REFERENCE_END(): TokenizerState {
     ...
     * @returns The next state.
     */
    protected CHARACTER_REFERENCE_END(): TokenizerState {
    ...
    protected X_EXPRESSION_START(cp: number): TokenizerState {
        if (cp === LEFT_CURLY_BRACKET) {
            this.startToken('XExpressionStart');
    ...
    protected X_EXPRESSION_END(cp: number): TokenizerState {
        if (cp === RIGHT_CURLY_BRACKET) {
            this.startToken('XExpressionEnd');
