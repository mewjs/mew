...
describe('css', function () {
    ...
    it('lint', async function () {
        const result = await lint('stylelint/app.css', 'css');
        ...
        assert.strictEqual(err2.rule, 'max-line-length', 'has rule');
